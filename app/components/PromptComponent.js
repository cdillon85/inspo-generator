...
const PromptComponent = (props) => {
	...
	const prompts = [{id: 1, text: 'My heart is broken.'}, {id: 2, text: 'Nothing ever goes right for me.'},
				...
				{id: 5, text: 'I am feeling unmotivated.'}, {id: 6, text: 'I am afraid to step outside my comfort zone.'},
	...
	<div>
		...
		{prompts.map(prompt => ( <div className="prompt" key={prompt.id} onClick={() => handleClick('/inspo')}>{prompt.text}</div>))}
		</div>
	</div>
